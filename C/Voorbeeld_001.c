...
/**
 ...
 (int argc, char* argv[])  -- dit is de array van command line arguments die bijvoorbeeld door een shell
 ...
 Je kunt dit programma compileren door 'cc myfile.c -o myprogram' uit te voeren (en dan ./myprogram om het uit te voeren).
